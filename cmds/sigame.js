...
module.exports.run = async(bot, message, args) => {
    ...
    if (typeof message.member.voiceChannel == "undefined") return message.author.send('Уважаемый пользователь, подключитесь в любой из голосовых каналов для того чтобы воспользоваться командой **!sigame**')
        message.guild.createChannel("Своя Игра", {type: "voice"}).then(channel => {
            ...
            channel.createInvite().then(invite => {
                ...
                .setDescription(`@everyone\nПрямо сейчас пройдет ивент **СВОЯ ИГРА**\n**Ведущий ивента:** ${message.author}\n**Место проведения ивента:** ${invite}\n**Правила проведения ивента:** Можно узнать, написав !erules в любой из текстовых каналов.\n**Скачать игру можно по ссылке:** https://vladimirkhil.com/si/game\n**Играть онлайн:** http://vladimirkhil.com/si/online`)
                .setAuthor("Оповещение о Ивенте!", bot.user.displayAvatarURL)
                .setImage("https://cdn.discordapp.com/attachments/577208827548794884/622485456059236362/149571862719423170.gif")
                .setColor(0x36393F)
