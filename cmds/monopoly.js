...
module.exports.run = async(bot, message, args) => {
    ...
    if (typeof message.member.voiceChannel == "undefined") return message.author.send('Уважаемый пользователь, подключитесь в любой из голосовых каналов для того чтобы воспользоваться командой **!monopoly**')
        message.guild.createChannel("Монополия", {type: "voice"}).then(channel => {
