...
module.exports.run = async(bot, message, args) => {
    ...
    if (typeof message.member.voiceChannel == "undefined") return message.author.send('Уважаемый пользователь, подключитесь в любой из голосовых каналов для того чтобы воспользоваться командой **!pravda**')
        message.guild.createChannel("Правда или Действие", {type: "voice"}).then(channel => {
...
module.exports.help = {
    name: "pravda",
    aliases: ["правда", "правдаилидействие"]
}